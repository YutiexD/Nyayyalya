...
**Recommendation: stand up W4's CI pipeline before anything else.** With 6+ people writing code in parallel, an unenforced `main` branch is how the 455-test suite silently breaks. This is a half-day task and it should block nothing else while it happens.
